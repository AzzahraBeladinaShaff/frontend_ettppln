...
const Piket = () => {
  return (
    <div>
      <h3 className="mb-4">Piket</h3>

      <div className="bg-white justify-content-between gap-4 bglembur">
        <div >
          <h3 className="biru judul_font">Buat Surat Perintah Kehadiran Piket mu!</h3>
          <p className="text_isi buram">Silahkan isi dengan sebenar-benarnya!</p>

          <div className="d-flex gap-5">
          <div>
          <div className="d-flex gap-1">
            <h6 className="text_label">Piket Hari/Tanggal</h6>
          ...
          <div>
          <div className="d-flex gap-1">
            <h6 className="text_label">Jenis Piket</h6>
            <p className="grey"> (wajib diisi)</p>
          </div>
          <div className="text_label">
          <Select
              ...
              />
            <p className="grey noted">Contoh: Piket Khusus</p>
          </div>
          </div> 
          </div>
        ...
        Batal
          ...
          <div className="py-5">
            ...
            <h4 className="biru judul_font2">Lihat History Piket mu!</h4>

            <div className="d-flex history_piket">
