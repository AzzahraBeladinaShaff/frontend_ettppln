...
const { Option } = Select;
const selectFilters = (
  <Select defaultValue="Filters" style={{ width: 100 }}>
  ...
  return (
    <div>
      ...
      <div className="bg-white justify-content-between gap-4 bglembur">
        <div>
          <h3 className="biru judul_font">Buat Pelaporan Premi mu!</h3>
          <p className="text_isi buram">
            Silahkan isi dengan sebenar-benarnya!
          </p>
          ...
          <div className="d-flex gap-5">
            ...
            <div>
              <div className="d-flex gap-1">
                <h6 className="text_label">Jenis Shift</h6>
                <p className="grey"> (wajib diisi)</p>
              </div>
              <div className="text_label">
                <Select
          ...
          <div className="d-flex gap-5">
            <div>
              ...
              <div className="text_label">
                ...
                <p className="grey noted">
                  Contoh: Lembur Operasional Pembangkit
                </p>
              </div>
            </div>
        ...
        <div className="d-flex text_label gap-2">
          <Button
            ...
            style={{ background: "#007DFA", width: 100 }}
            type="submit"
          >
            Kirim
          </Button>
        ...
        <div className="py-5">
          <div className="d-flex">
            <h4 className="biru judul_font2">
              Lihat History Pelaporan Premi mu!
            </h4>

            <div className="d-flex history_premi">
              <div className="select_bulan">
                <Space direction="vertical">
                  <Input
                    addonBefore={<AiOutlineSearch />}
                    addonAfter={selectFilters}
